...
<html lang="no">
	...
	<body>
		...
		<nav class="navbar navbar-expand-md navbar-dark bg-red sticky-top">
			<div class="container-fluid" id="analyseImage">
				 <a class="navbar-brand" href="index.php">FoodSnap</a><span id="bruker"></span>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown text-center" id="myPage">
							 ...
							 <div class="dropdown-menu" aria-labelledby="navbarDropdown">
								  <a class="dropdown-item" href="minaktivitet.html" target="_blank">Mine Aktivitet</a>
								  <a class="dropdown-item" href="profile.html" target="_blank">Innstillinger</a>
								  <a class="dropdown-item" href="admin.html" id="adminPage" target="_blank">Admin</a>
		...
		<div class="container-fluid padding">
			...
			<div class="row text-center">
				<div class="col-12">
					<form action="" name="analyseImage" id="analyseImage" method="post" enctype="multipart/form-data">
						<canvas class="img-fluid" id="hjem" onclick="activateCamera();" style="height:400px; width:auto;"></canvas>
						<div>
							  <div class="intro-text" id="flyttHitEtterBildeAnalyses">
								  <button data-intro="Trykk her for å ta bilde" class="intro-lead-in" type="button" class="btn btn-default" id="taBilde">
										<iclass="fas fa-camera"></i>Ta bilde
								  </button>
								  <button data-intro="Trykk her for å laste opp bilde lokalt fra din enhet" class="intro-heading" type="button"class="btn btn-default" id="lastOppBilde">
		...
		<div class="container-fluid padding sticky">
		<div class="text-center">
			<div class="lines">
					<div class="btn-group btn-group-lg" id="fanContent">
						<div data-preset="line4" class="ldBar label-center" id="kcall" data-min="0" data-max="3000" data-value="0"></div>
